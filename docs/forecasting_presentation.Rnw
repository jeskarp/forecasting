...
exponential growth rate & compartmental & branching process \\
...
\begin{textblock}{1}(0.05, 0.80)
\small{\textcolor{gray}{Ebola Outbreak Epidemiology Team 2018 \textit{Lancet}, Chowell et al. 2007 \textit{J. Royal Soc. Interface}, Funk et al. 2018 \textit{bioRxiv}, Nouvellet et al. 2017 \textit{Epidemics}}}
\end{textblock}
\end{frame}
...
\begin{tcolorbox}[colback=red!50!white, colframe=red!50!white, size=title]
\begin{center}
...
\begin{itemize}
   ...
   \item developing a tool for visualising performance amongst all metrics at once
   \item considering the impact of imperfect reporting (eg. under-reporting, reporting delays)
\end{itemize}
\end{frame}
