...
* When it comes to the real-time modelling of ongoing outbreaks, the effective reproduction number for a time window, Rt, is the calculated measure.
* Not all methods of calculating Rt perform equally well (ref. Viboud et al. 2017).
