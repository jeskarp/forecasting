...
epiestim_R <- EstimateR(i, T.Start = c(2, 9), T.End = c(8, 14), method = c("ParametricSI"), Mean.SI = mu, Std.SI = sigma)
...
library(incidence)
Flu2009_newinc <- as.incidence(c(Flu2009_incidence$Incidence)) # The data that you pretend you actually have
